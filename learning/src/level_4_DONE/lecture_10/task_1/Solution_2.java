package level_4_DONE.lecture_10.task_1;
 ...
 * В зависимости от полученных данных, округлить переменную glass: до целого числа вниз (0), если пессимист (false)
...
public class Solution_2 {
    public static void main(String[] args) {
        ...
        boolean full = scanner.nextBoolean();
