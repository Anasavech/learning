package level_7.lecture_4_here.task_2;

/**
 * Данная программа должна выводить информацию о созданном массиве. Но из-за неправильно расставленных
 * модификаторов static она не компилируется.
...
public class Solution_1_here_неИзучала {
...
/**
 * БОЛЬШАЯ, ТЯЖЕЛАЯ ТЕМА, НЕ УСПЕЛИ
 */
