package level_14.lecture_3.task_2;
 ...
 *
 * Требования:
 * В классе Solution должен быть публичный статический метод copy(ArrayList<String>, ArrayList<String>)
 * с типом возвращаемого значения void.
 * В классе Solution должен быть публичный статический метод addAll(ArrayList<String>, String...)
 * с типом возвращаемого значения void.
 * В классе Solution должен быть публичный статический метод replaceAll(ArrayList<String>, String, String)
 * с типом возвращаемого значения void.
