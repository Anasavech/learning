package level_3_DONE.lecture_6.task_3;

import java.util.Scanner;

/**
 * Ввести с клавиатуры два целых числа, которые будут координатами точки (первое считанное число - это координата "x",
 * а второе - координата "y"). Известно, что точка не лежит на координатных осях OX и OY.4
...
public class Solution_1 {
    public static void main(String[] args) {
        ...
        //Не буду считать ошибкой, но код можно сократить без использования доп переменных
        //Подумай, как можно сделать без использования one, two, three, four

        //Сделала в Solution_1_2
        boolean one = (x>0) && (y>0);
        boolean two = (x<0) && (y>0);
